...
if __name__ == "__main__":
    ...
    parser.add_argument('-se','--selected_embryos',default=['3Bal2_eB', '5Sachk3_eB', '6069_1_K', '7493_K', '8388_1_K', '8388_3_K', 'Aks1_K', 'Aks_K', 'BOC_K1', 'BOC_e1', 'BTR_e3', 'BTR_e9', 'Bal1_K', 'Bal1_eB', 'Bal3_e', 'Boc_e4', 'CHR_K1', 'CHR_e1', 'Ch-D_e', 'Chal_K1', 'Chal_e', 'Dik_e', 'Dik_e1', 'Fed1_e', 'Fisher1_K', 'Gri2_e', 'HAN_K5', 'HAN_e5', 'IlI_K3', 'IlI_e4', 'Isa1_e', 'K11', 'K13', 'Kaz1_e', 'Kaz3_K', 'Kira1_K2', 'Kond3_K', 'Kond4_K', 'Kov1_e', 'Kov2_e', 'Kra1_e', 'Kra3_K', 'Kra_e', 'Kul_K', 'Kur3_e', 'Kus1_K', 'MAD_K3', 'MAD_e3', 'Mar1_K', 'Pan1_K', 'Pash_K2', 'Pash_K3', 'Pash_e2', 'Pash_e3', 'Sach1_K_2110', 'Sach2_K', 'Sav4_e', 'Sav4_eB', 'Say3_K', 'Sheg1_K2', 'Sheg1_e', 'Shen1_K', 'Shen1_e', 'Shen2_K', 'Shen2_e', 'Shen3_K', 'Shen3_e', 'Shur3_K', 'Ton1_e', 'Vla1_K_0705', 'Vla1_e', 'Vla9_e', 'Vor1_K', 'XAH_K13', 'XAH_e13', 'YAK_e4', 'Zap_K2', 'Zap_e2', 'Zap_e3', 'embryo6', 'microchip-c'], nargs='+', required=False, help='Names of selected embryos')
